...
export const ProjectStreamlinedExperience = () => {
  ...
  return (
    ...
    >
      <div className="sticky top-1/2 left-1/2 min-h-[20rem] min-w-[20rem] md:min-h-[35rem] md:min-w-[35rem] -translate-x-[10vw] md:-translate-x-[15vw] lg:-translate-x-1/2 -translate-y-1/2 whitespace-nowrap before:absolute before:inset-0 before:scale-[var(--scale)] md:before:border-[2rem] before:border-[1rem] before:border-primary-color before:opacity-[var(--opacity-border)]">
        <motion.p
          aria-hidden
          style={{ x: textX, y: "-50%" }}
        ...
        <span className="absolute left-[calc(50%*var(--scale)+50%-(1rem*var(--scale)))] md:left-[calc(50%*var(--scale)+50%-(2rem*var(--scale)))] top-0 z-[12] h-full w-[50vw] origin-left scale-[var(--scale)] border-l-[1rem] md:border-l-[2rem] border-primary-color opacity-[var(--opacity-border)]" />
      </div>
    </motion.section>
  );
};
